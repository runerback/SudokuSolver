...
{
	public static class SudokuConsole
	{
		public static void WaitLine()
		{
			WaitKey(ConsoleKey.Enter);
		}

		private static void WaitKey(ConsoleKey key)
		{
			while (!CheckKey(key)) { }
		}

		public static bool CheckLine()
		{
			return CheckKey(ConsoleKey.Enter);
		}

		public static bool CheckLeft()
		{
			return CheckKey(ConsoleKey.LeftArrow);
		}

		public static bool CheckRight()
		{
			return CheckKey(ConsoleKey.RightArrow);
		}

		private static bool CheckKey(ConsoleKey key)
		{
