...
namespace SudokuSolver.Definition
{
	...
	{
		internal static Line Row(GridLine segment1, GridLine segment2, GridLine segment3)
		{
			return new Line(segment1, segment2, segment3)
			{
				lineType = LineType.Row
			};
		}

		internal static Line Column(GridLine segment1, GridLine segment2, GridLine segment3)
		{
			return new Line(segment1, segment2, segment3)
			{
		...
		private Line(GridLine segment1, GridLine segment2, GridLine segment3)
		{
